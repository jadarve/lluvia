...
vk::SamplerCreateInfo ImageViewDescriptor::getVkSamplerCreateInfo() const noexcept
{
    ...
    auto getVkAddressMode = [](const ll::ImageAddressMode addressModeValue) {
        ...
        case ll::ImageAddressMode::Repeat:
            return vk::SamplerAddressMode::eRepeat;
        case ll::ImageAddressMode::MirroredRepeat:
            return vk::SamplerAddressMode::eMirroredRepeat;
        case ll::ImageAddressMode::ClampToEdge:
            return vk::SamplerAddressMode::eClampToEdge;
        case ll::ImageAddressMode::ClampToBorder:
            return vk::SamplerAddressMode::eClampToBorder;
        case ll::ImageAddressMode::MirrorClampToEdge:
