...
function builder.newDescriptor() 
    ...
    desc.builderName  = 'ImageDownsampleY_gray'
    desc.localShape   = ll.vec3ui.new(32, 32, 1)
    desc.gridShape    = ll.vec3ui.new(1, 1, 1)
    desc.program      = ll.getProgram('ImageDownsampleY_gray')
...
function builder.onNodeInit(node)
    ...
    ll.logd('ImageDownsampleY_gray', 'in_gray ', string.format('[%d, %d]', in_gray.width, in_gray.height)
...
ll.registerNodeBuilder('ImageDownsampleY_gray', builder)
